...
export default function CotisationExceptionnelleDetails() {
  const [, params] = useRoute("/cotisation-exceptionnelle/:id");
  ...
  const mockOperation = {
    ...
    nom: "Cotisation Exceptionnelle Q1",
    type: "COTISATION_EXCEPTIONNELLE" as const,
    montantCible: 75000,
